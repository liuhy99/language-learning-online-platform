    ...
    <form method="post" class="form-x" action="${path}/admin/bankuai/updateoradd.do" id="form">
      ...
      <div class="form-group">
        ...
        <c:forEach items="${jifengouplist}" var="jifengoup">
		  <input type="checkbox" name="findcheckbox" value="${jifengoup.name}"/>${jifengoup.name}
        </c:forEach>
      ...
      <div class="form-group">
        ...
        <c:forEach items="${jifengouplist}" var="jifengoup">
		  <input type="checkbox" name="fatiecheckbox" value="${jifengoup.name}"/>${jifengoup.name}
        </c:forEach>
      ...
      <div class="form-group">
        ...
        <c:forEach items="${jifengouplist}" var="jifengoup">
		  <input type="checkbox" name="huifucheckbox" value="${jifengoup.name}"/>${jifengoup.name}
        </c:forEach>
